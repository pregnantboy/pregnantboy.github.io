...
gulp.task("vendor", () => {
	...
	gulp.src(["./node_modules/bootstrap/dist/**/*",
		...
		"!./node_modules/bootstrap/dist/css/bootstrap-reboot*"]).pipe(gulp.dest("./vendor/bootstrap"));

	// jQuery
	gulp.src(["./node_modules/jquery/dist/*", "!./node_modules/jquery/dist/core.js"]).pipe(gulp.dest("./vendor/jquery"));

	gulp.src(["./node_modules/typed.js/lib/typed.min.js"]).pipe(gulp.dest("./vendor/typed.js"));
});
